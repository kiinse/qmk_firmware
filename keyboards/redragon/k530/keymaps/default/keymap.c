...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = { {   KC_ESC,          KC_1,                 KC_2,          KC_3,             KC_4,       KC_5,    KC_6,    KC_7,       KC_8,       KC_9,       KC_0,       KC_MINS,    KC_EQL,               KC_BSPC, },
                ...
                {   KC_LCTL,         KC_LGUI,              KC_LALT,       KC_NO,            KC_NO,      KC_NO,   KC_SPC,  KC_NO,      KC_NO,      KC_RALT,    MO(_FN),    KC_NO,      LT(_FN2, KC_APP),     KC_DEL, },
              },
    [_FN]   = { {   KC_GRV,          KC_F1,                KC_F2,         KC_F3,            KC_F4,      KC_F5,   KC_F6,   KC_F7,      KC_F8,      KC_F9,      KC_F10,     KC_F11,     KC_F12,               RESET,   },
    ...
    [_FN2]   = { {  RESET,           KC_KB_VOLUME_DOWN,    KC_KB_MUTE,    KC_KB_VOLUME_UP,  _______,    _______, _______, _______,    RGB_RMOD,   RGB_MOD,   RGB_TOG,   RGB_VAD,   RGB_VAI,             _______, },
                {   KC_PSCR,         KC_INS,               KC_HOME,       KC_PGUP,          _______,    _______, _______, _______,    _______,    _______,    _______,    _______,    _______,              _______, },
                {   _______,         KC_DEL,               KC_END,        KC_PGDN,          _______,    _______, _______, _______,    _______,    _______,    _______,    _______,    _______,              _______, },
                {   _______,         _______,              _______,       _______,          _______,    _______, _______, _______,    _______,    _______,    _______,    _______,    _______,              _______, },
                {   _______,         _______,              _______,       _______,          _______,    _______, _______, _______,    _______,    _______,    _______,    _______,    _______,              _______, },
             },
};
