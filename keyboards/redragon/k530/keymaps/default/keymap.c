...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN2]   = { {  RESET,           KC_VOLD, KC_MUTE, KC_VOLU,  _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, RGB_VAI, RGB_MOD,         KC_DEL,  },
                {   KC_PSCR,         KC_INS,  KC_HOME, KC_PGUP,  _______, _______, _______, _______, _______, _______, _______, RGB_SAI, RGB_HUI,         RGB_TOG, },
